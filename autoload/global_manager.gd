...
@onready var transitions  = {
		"circle" = preload("res://transitions/scenes/hole.tscn"),
...
func goto_scene(levelinfo:LevelInfo, transition:String="rectangle"):
	_new_level = levelinfo #indica que deve-se carregar esta cena
